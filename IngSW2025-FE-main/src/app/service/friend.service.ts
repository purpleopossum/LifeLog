...
import { Friendship, FriendshipResponse } from '../dto/friend.model';
@Injectable({
  providedIn: 'root'
})
export class FriendService {
    ...
    request(senderId: string, friendCode: string): Observable<FriendshipResponse> {
        return this.http.post<FriendshipResponse>(
            `${this.apiUrl}/request?senderId=${senderId}&friendCode=${friendCode}`, {}
        );
    }
